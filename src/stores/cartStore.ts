...
interface CartStore {
  ...
  buyNow: (item: Omit<CartItem, 'lineId'>) => Promise<void>;
  updateQuantity: (variantId: string, quantity: number) => Promise<void>;
  removeItem: (variantId: string) => Promise<void>;
  clearCart: () => void;
  syncCart: () => Promise<void>;
  getCheckoutUrl: () => string | null;
  setHairDescription: (description: string) => void;
...
export const useCartStore = create<CartStore>()(
  persist(
    (set, get) => ({
      ...
      clearCart: () => set({ items: [], cartId: null, checkoutUrl: null, hairDescription: '' }),
      getCheckoutUrl: () => get().checkoutUrl,
      setHairDescription: (description: string) => set({ hairDescription: description }),
    ...
    }),
    {
      ...
      partialize: (state) => ({ items: state.items, cartId: state.cartId, checkoutUrl: state.checkoutUrl, hairDescription: state.hairDescription }),
    }
  )
);
